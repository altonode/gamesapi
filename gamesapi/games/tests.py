...
class GameCategoryTests(APITestCase):
    ...
    def test_create_duplicated_game_category(self):
	    ...
	    response_1 = self.create_game_category(new_game_category_name)
	    self.assertEqual(response_1.status_code, status.HTTP_201_CREATED)
	    response_2 = self.create_game_category(new_game_category_name)
...
class PlayerTests(APITestCase):
    ...
    def test_create_duplicated_player(self):
	    ...
	    response_1 = self.create_player(new_player_name, new_player_gender)
	    self.assertEqual(
		    response_1.status_code, 
			status.HTTP_201_CREATED)
	    response_2 = self.create_player(new_player_name, new_player_gender)
	    self.assertEqual(
